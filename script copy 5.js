...
const VISIBILITY_DISTANCE = 15;   // meters — chest visible within this distance
const CAPTURE_DISTANCE    = 5;    // meters — can capture/open within this distance

// FIXED BASE COORDINATES (reference point)
const BASE_LATITUDE = 28.412200;
const BASE_LONGITUDE = 77.109155;
...
window.onload = () => {
  ...
  treasureLocation = offsetLatLng(BASE_LATITUDE, BASE_LONGITUDE, 5, 0); // 0 degrees = North
